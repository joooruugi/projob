...
public class AdviceLog {
	...
	@Pointcut("execution(public * fin.spring.projob..*Dao.*(..))")
	public void commonDaoPointCut() {}
	@Pointcut("execution(public * fin.spring.projob..*Service.*(..))")
	public void commonServicePointCut() {}
	@Pointcut("execution(public * fin.spring.projob..*Controller.*(..))")
